                ...
                <div className={styles['widget_shopping_cart_content']} >
                  <ul className={styles['product_list_widget']} >
                    {cartItems.map((item) => (
                        ...
                        <a href="#">
              						<img width="324" height="324" src={item.image_url} className={styles['thumbnail']} alt="" ></img>{item.name}</a>
              				  <span className={styles['quantity']}>{item.quantity} × <span className={styles['price-amount']}><span>$</span>{item.sale_price.toFixed(2)}</span></span>
                      </li>
                    ))}
            			</ul>
                	<p className={styles['mini-cart__total']} >
              		  <strong>Subtotal:</strong> <span className={styles['price-amount']}><span>$</span>{cartSubTotal}</span>
                  </p>
                  <p className={styles['mini-cart__buttons']} >
                    <a href={cartData?.redirect_urls.cart_url} className={styles['button']} >View cart</a>
                    <a href={cartData?.redirect_urls.checkout_url} className={styles['button']} >Checkout</a>
                  </p>
                </div>
              </div>
            </li>
